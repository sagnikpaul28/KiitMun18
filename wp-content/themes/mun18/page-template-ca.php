...
if (isset($_POST['form-name']) && isset($_POST['form-email']) && isset($_POST['form-phone']) && isset($_POST['form-college']) && isset($_POST['form-stream']) && isset($_POST['form-experience']) && isset($_POST['form-knowledge'])){
	...
	$sql = "INSERT INTO campus_ambassador(id,fullname,contact,mailid,college,stream,experience,knowledge) VALUES(0,'$name','$phone','$email','$college','$stream','$experience','$knowledge')";
$chk = 0;
...
if($chk==0){
	?>
<div class="col-xs-10 col-xs-offset-1 col-sm-10  col-md-6 col-md-offset-1  col-sm-offset-1 col-lg-6 col-lg-offset-1">
...
echo "<div class = \"col-xs-10 col-sm-10 col-md-6 col-md-offset-1 col-lg-6 col-lg-offset-1 col-xs-offset-1\">";
echo "<h3 style=\"text-align:center; margin-top:30px;\">Thank you for applying. We will get back to you soon.</h3>";
echo "</div>";
}
?>
<div class="class=col-xs-10 col-xs-offset-0 col-sm-10 col-sm-offset-0 col-md-4 col-lg-4">
<h1>Your <b>Incentives</b></h1>
<hr>
<div>
<ul class="list-group">
	<li class="list-group-item">Free Accomodation during KiiT MUN.</li>
	<li class="list-group-item">Access to the Social Nights.</li>
	<li class="list-group-item">Waiver in delegate fees based on the number of delegates you bring.</li>
	<li class="list-group-item">Certificate from KiiT MUN Society.</li>
	<li class="list-group-item">Trophy from the Kiit MUN Society.</li>
	<li class="list-group-item">Coupons and Gift Voulchers.</li>
