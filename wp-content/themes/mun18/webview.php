<?php
/*Template Name: Web view contact Page */
$chk = 0;
if (isset($_POST['form-name']) && isset($_POST['form-email']) && isset($_POST['form-message'])){
...
<div class="container">
	<div class="row">
			<h4 style="text-align:center">For further queries, please feel free to contact <b>+917873466022.</h4>
	</div>
