...
function style_enqueue(){
	...
	wp_enqueue_style('mycss', get_template_directory_uri().'/assets/css/index.css', array(), '', 'all');
	wp_enqueue_script('myjs', get_template_directory_uri().'/assets/js/index.js', array('jquery'), null, true);
}
